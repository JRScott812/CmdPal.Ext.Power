...
namespace CmdPal.Ext.Power.Helpers
{
	internal sealed partial class PowerModeService : IDisposable
	{
		...
		internal static PowerModeSnapshot GetSnapshot()
		{
		...
		internal static bool SupportsPowerModeControl() => GetSnapshot().CanReadUserMode;

		internal static bool TrySetUserPowerMode(UserPowerMode mode, out string? errorMessage)
		{
			errorMessage = null;
